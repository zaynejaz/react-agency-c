      ...
      <Container>
        <Flex sx={styles.flex}>
          <Box sx={styles.content}>
            ...
            <Text as="p">
              In order to give you the best email tools, all our features are built on with the most up to date, robust and efficient code frameworks, CMS and CDN platforms after being professionally designed and maintained from their inception. 
            </Text>
