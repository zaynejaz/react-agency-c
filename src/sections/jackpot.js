...
const JACKPOT_DATA = [
  {
    image: jackpotImage1,
    text:'Take email marketing beyond the inbox with advanced tools made easy, including a drag & drop editor and automation features.',
    heading: 'Balanced Email Marketing',
  },
  {
    image: jackpotImage2,
    text:'Our support team works around the clock to assist you whenever you have a question. Send us a message and we will get back to you.',
        ...
        <Flex sx={styles.flex}>
          ...
          <Box sx={styles.content}>
            <Box sx={styles.heading}>
              ...
              <Heading as="h3">Email the way it's meant to be</Heading>
            </Box>
